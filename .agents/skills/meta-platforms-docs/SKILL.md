...
description: "Reference for Meta developer platforms: Graph API, Pages, Instagram, Marketing API, Messenger, Webhooks, Login, App Review."
---
...
Use this skill whenever code or directives touch Facebook, Instagram, Messenger, Meta Marketing, or any Graph API surface. Fetch live docs on demand — Meta updates them frequently and pins versions quarterly.
...
9. **Fetch live docs** before quoting field names, required parameters, or error codes — Meta changes them often.
