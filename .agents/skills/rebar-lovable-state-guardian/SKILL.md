...
description: "Prevent AI app-builder agents from working from stale Lovable project state when editing, debugging, reviewing, deploying, or explaining the app."
---
