...
export const ARCH_NODES: ArchNode[] = [
  ...
  { id: "fn-social",   label: "Social",     hint: "Publish",        layer: "backend", accent: "blue", icon: Share2,     detail: { title: "Social Publish", bullets: ["Meta Graph API", "Multi-platform scheduling", "Content queue"] }, description: "Publishes content to social platforms via Meta Graph API with multi-platform scheduling." },
  { id: "fn-stripe",   label: "Stripe API",  hint: "Payments",       layer: "backend", accent: "blue", icon: CreditCard, detail: { title: "Stripe Integration", bullets: ["Payment processing", "Webhook handling", "Invoice management"] }, description: "Processes payments, handles Stripe webhooks, and manages invoice lifecycle." },
  { id: "fn-ring",     label: "RC API",      hint: "Telephony",     layer: "backend", accent: "blue", icon: Phone,      detail: { title: "RingCentral Sync", bullets: ["Call log sync", "Webhook events", "SMS integration"] }, description: "Syncs call logs, processes telephony webhooks, and handles SMS messaging via RingCentral." },
  { id: "fn-gmail",    label: "Gmail",       hint: "Email API",      layer: "backend", accent: "blue", icon: MailOpen,   detail: { title: "Gmail Integration", bullets: ["Email send & receive", "Thread tracking", "Draft management"] }, description: "Sends and receives emails via Gmail API with thread tracking and draft management." },
  { id: "fn-odoo",     label: "Odoo Sync",   hint: "ERP sync",       layer: "backend", accent: "blue", icon: Building2,  detail: { title: "Odoo Integration", bullets: ["Product & inventory sync", "Order management", "XML-RPC bridge"] }, description: "Bidirectional ERP sync with Odoo for products, inventory, and order management." },
  { id: "fn-qb",       label: "QB Sync",     hint: "Accounting",     layer: "backend", accent: "blue", icon: BookOpen,   detail: { title: "QuickBooks Sync", bullets: ["Customer & invoice mirroring", "OAuth2 token refresh", "Balance sync"] }, description: "Mirrors customers and invoices with QuickBooks Online with automatic token refresh." },
  { id: "fn-seo",      label: "SEO Engine", hint: "Audit",          layer: "backend", accent: "blue", icon: FileSearch, detail: { title: "SEO Backend", bullets: ["PageSpeed analysis", "Core Web Vitals", "Keyword tracking"] }, description: "Runs PageSpeed analysis, tracks Core Web Vitals, and monitors keyword rankings." },
  { id: "fn-ai",       label: "AI Gateway", hint: "LLM proxy",      layer: "backend", accent: "blue", icon: Zap,        detail: { title: "AI Gateway", bullets: ["Multi-model routing", "Usage logging", "Rate limiting"] }, description: "Central LLM proxy that routes requests to multiple AI models with usage logging and rate limiting." },
  { id: "fn-push",     label: "Push",       hint: "Notifications",  layer: "backend", accent: "blue", icon: Bell,       detail: { title: "Push Notifications", bullets: ["DB trigger pipeline", "Multi-channel delivery", "Escalation rules"] }, description: "Delivers push notifications via DB triggers with multi-channel routing and escalation." },
  { id: "cameras",     label: "Cameras",    hint: "Security",       layer: "backend", accent: "blue", icon: Camera,     detail: { title: "Camera / Security", bullets: ["RTSP camera feeds", "Face recognition", "Event detection & alerts"] }, description: "Manages RTSP camera feeds with face recognition, event detection, and security alerts." },
  { id: "fn-website",  label: "Website",    hint: "Agent + chat",   layer: "backend", accent: "blue", icon: Globe2,     detail: { title: "Website Agent", bullets: ["Website chat widget", "AI-powered responses", "Lead capture"] }, description: "Public-facing website chat widget with AI-powered responses and lead capture." },
  { id: "fn-mcp",      label: "MCP",        hint: "Agent protocol", layer: "backend", accent: "blue", icon: Plug,       detail: { title: "MCP Server", bullets: ["Model Context Protocol", "Tool registry", "Agent interop bridge"] }, description: "Model Context Protocol server bridging external agents with internal tool registry." },

  // Layer 6: External Services
  { id: "ext-meta",    label: "Meta",       hint: "FB & IG",        layer: "external", accent: "rose", icon: Instagram,   detail: { title: "Meta Platform", bullets: ["Facebook Graph API", "Instagram Business API", "Ad campaigns"] }, description: "External Meta platform providing Facebook and Instagram APIs for social publishing and ads." },
  { id: "ext-stripe",  label: "Stripe",     hint: "Payments",       layer: "external", accent: "rose", icon: DollarSign,  detail: { title: "Stripe", bullets: ["Payment processing", "Subscription billing", "Webhook events"] }, description: "External Stripe payment platform for processing payments, subscriptions, and webhooks." },
  { id: "ext-rc",      label: "RingCentral", hint: "VoIP",          layer: "external", accent: "rose", icon: PhoneCall,   detail: { title: "RingCentral", bullets: ["Voice & SMS API", "Call recording", "WebRTC"] }, description: "External RingCentral VoIP platform for voice calls, SMS, and call recording." },
  { id: "ext-google",  label: "Google",     hint: "Suite",          layer: "external", accent: "rose", icon: Chrome,      detail: { title: "Google Services", bullets: ["Gmail API", "Search Console", "OAuth2"] }, description: "External Google services including Gmail API, Search Console, and OAuth2 authentication." },
  { id: "ext-odoo",    label: "Odoo",       hint: "ERP",            layer: "external", accent: "rose", icon: Boxes,       detail: { title: "Odoo ERP", bullets: ["XML-RPC API", "Inventory", "Product catalog"] }, description: "External Odoo ERP system providing inventory, product catalog, and order data via XML-RPC." },
  { id: "ext-qb",      label: "QuickBooks", hint: "Intuit",         layer: "external", accent: "rose", icon: Receipt,     detail: { title: "QuickBooks Online", bullets: ["REST API v3", "Invoice sync", "OAuth2"] }, description: "External QuickBooks Online providing accounting data via REST API v3 with OAuth2." },
  { id: "ext-openai",  label: "OpenAI",     hint: "GPT & Realtime", layer: "external", accent: "rose", icon: Sparkles,    detail: { title: "OpenAI", bullets: ["GPT-4o", "Realtime API", "Embeddings"] }, description: "External OpenAI platform providing GPT-4o, Realtime API, and embeddings for AI features." },
  { id: "ext-eleven",  label: "ElevenLabs", hint: "Voice + TTS",    layer: "external", accent: "rose", icon: AudioLines,  detail: { title: "ElevenLabs", bullets: ["Text-to-speech", "Voice cloning", "Music generation"] }, description: "External ElevenLabs platform for text-to-speech, voice cloning, and audio generation." },

  // Layer 7: Data + Platform
  { id: "primary-db",    label: "Primary DB",    hint: "PostgreSQL",   layer: "platform", accent: "amber", icon: Database,      detail: { title: "Primary Database", bullets: ["Supabase PostgreSQL", "RLS policies", "Source of truth"] }, description: "Core PostgreSQL database with row-level security policies serving as the single source of truth." },
  { id: "obj-storage",   label: "Storage",       hint: "Files & media", layer: "platform", accent: "amber", icon: Archive,       detail: { title: "Object Storage", bullets: ["Supabase Storage", "Media uploads", "CDN delivery"] }, description: "Object storage for media uploads, documents, and static assets with CDN delivery." },
  { id: "redis-cache",   label: "Redis Cache",   hint: "Fast reads",   layer: "platform", accent: "amber", icon: Zap,           detail: { title: "Redis Cache", bullets: ["Session cache", "Rate limit counters", "Hot data"] }, description: "In-memory Redis cache for sessions, rate limit counters, and frequently accessed hot data." },
  { id: "search-idx",    label: "Search Index",  hint: "Full-text",    layer: "platform", accent: "amber", icon: Search,        detail: { title: "Search Index", bullets: ["Full-text search", "Faceted filtering", "Relevance ranking"] }, description: "Full-text search index with faceted filtering and relevance-based ranking." },
  { id: "event-log",     label: "Event Log",     hint: "Audit trail",  layer: "platform", accent: "amber", icon: Activity,      detail: { title: "Event Log", bullets: ["activity_events table", "All system actions", "Compliance audit"] }, description: "Immutable audit trail logging all system actions for compliance and debugging." },
  { id: "job-queue",     label: "Job Queue",     hint: "Async hub",    layer: "platform", accent: "amber", icon: GitBranch,     detail: { title: "Job Queue", bullets: ["Async task dispatch", "Priority scheduling", "Retry policies"] }, description: "Async task dispatch hub with priority scheduling and configurable retry policies." },
  { id: "worker-pool",   label: "Worker Pool",   hint: "Executors",    layer: "platform", accent: "amber", icon: Cpu,           detail: { title: "Worker Pool", bullets: ["Edge function workers", "Concurrent execution", "Auto-scaling"] }, description: "Pool of edge function workers for concurrent task execution with auto-scaling." },
  { id: "retry-queue",   label: "Retry Queue",   hint: "Retries",      layer: "platform", accent: "amber", icon: RefreshCw,     detail: { title: "Retry Queue", bullets: ["Exponential backoff", "Max retry limits", "Failure routing"] }, description: "Handles failed jobs with exponential backoff, retry limits, and dead-letter routing." },
  { id: "dlq",           label: "Dead Letter",   hint: "Failed jobs",  layer: "platform", accent: "amber", icon: AlertTriangle, detail: { title: "Dead Letter Queue", bullets: ["Permanently failed jobs", "Manual review", "Alert triggers"] }, description: "Captures permanently failed jobs for manual review and triggers admin alerts." },
  { id: "monitoring",    label: "Monitoring",    hint: "Observability", layer: "platform", accent: "amber", icon: MonitorCheck,  detail: { title: "Monitoring", bullets: ["Prometheus metrics", "Grafana dashboards", "Alerting rules"] }, description: "System observability with Prometheus metrics, Grafana dashboards, and alerting rules." },
  { id: "error-track",   label: "Error Track",   hint: "Errors",       layer: "platform", accent: "amber", icon: ServerCrash,   detail: { title: "Error Tracking", bullets: ["Exception capture", "Stack trace logging", "Error grouping"] }, description: "Captures and groups runtime exceptions with stack traces for debugging and resolution." },
  { id: "cicd",          label: "CI/CD",         hint: "Deploy",       layer: "platform", accent: "amber", icon: Rocket,        detail: { title: "CI/CD Pipeline", bullets: ["Automated builds", "Test suites", "Zero-downtime deploy"] }, description: "Automated build and deployment pipeline with test suites and zero-downtime deploys." },
  { id: "secrets-mgr",   label: "Secrets",       hint: "Vault",        layer: "platform", accent: "amber", icon: Lock,          detail: { title: "Secrets Manager", bullets: ["API key storage", "Token rotation", "Encrypted vault"] }, description: "Encrypted vault for API keys and tokens with automatic rotation and access control." },
  { id: "backups",       label: "Backups",       hint: "Recovery",     layer: "platform", accent: "amber", icon: DownloadCloud, detail: { title: "Backups", bullets: ["Daily snapshots", "Point-in-time recovery", "Geo-redundant storage"] }, description: "Daily database snapshots with point-in-time recovery and geo-redundant storage." },
  { id: "admin-console", label: "Admin",         hint: "Management",   layer: "platform", accent: "amber", icon: Users,         detail: { title: "Admin Console", bullets: ["User management", "System configuration", "Feature flags"] }, description: "Administrative console for user management, system configuration, and feature flag control." },
  { id: "settings",      label: "Settings",      hint: "Config",       layer: "platform", accent: "amber", icon: Settings,       detail: { title: "Settings", bullets: ["App configuration", "User preferences", "System parameters"] }, description: "Central configuration hub for app settings, user preferences, and system parameters." },
  { id: "cdn-edge",      label: "CDN / Edge",    hint: "Delivery",     layer: "platform", accent: "amber", icon: Globe,         detail: { title: "CDN / Edge", bullets: ["Static asset delivery", "Edge caching", "Global distribution"] }, description: "Global CDN for static asset delivery with edge caching and worldwide distribution." },
  { id: "memory-store",  label: "Memory",        hint: "AI & CRM memory", layer: "platform", accent: "amber", icon: MemoryStick,   detail: { title: "Memory Store", bullets: ["Vizzy brain & lead memory", "Qualification / quote / loss memory", "Client performance memory"] }, description: "Persistent AI memory store for Vizzy brain, lead qualification, and client performance data." },
  { id: "realtime",      label: "Realtime",      hint: "Live events",  layer: "platform", accent: "amber", icon: Radio,         detail: { title: "Realtime Engine", bullets: ["Supabase Realtime", "Live chat & dashboards", "Presence & notifications"] }, description: "Real-time event engine powering live chat, dashboard updates, and presence tracking." },
  { id: "rate-limiter",  label: "Rate Limiter",  hint: "Throttle",     layer: "platform", accent: "amber", icon: Gauge,         detail: { title: "Rate Limiter", bullets: ["Request rate limiting", "Per-user & per-route limits", "Burst protection"] }, description: "Request rate limiting with per-user and per-route limits and burst protection." },
  { id: "session-store", label: "Sessions",      hint: "Auth state",   layer: "platform", accent: "amber", icon: Key,           detail: { title: "Session Store", bullets: ["Auth session management", "Token storage & rotation", "SSO state"] }, description: "Manages authentication sessions with token storage, rotation, and SSO state persistence." },
  { id: "analytics",     label: "Analytics",     hint: "Telemetry",    layer: "platform", accent: "amber", icon: BarChart3,     detail: { title: "Analytics", bullets: ["Usage metrics", "System telemetry", "AI cost tracking"] }, description: "Collects usage metrics, system telemetry, and AI cost tracking for operational insights." },
  { id: "log-agg",       label: "Log Aggregator", hint: "System logs", layer: "platform", accent: "amber", icon: FileText,      detail: { title: "Log Aggregator", bullets: ["Centralized log collection", "Structured logging", "Log retention policies"] }, description: "Centralized log collection with structured logging and configurable retention policies." },
  { id: "health",        label: "Health Check",  hint: "Uptime",       layer: "platform", accent: "amber", icon: HeartPulse,    detail: { title: "Health Checks", bullets: ["Endpoint health probes", "Liveness & readiness", "Uptime monitoring"] }, description: "Health check probes monitoring endpoint liveness, readiness, and overall uptime." },
  { id: "feature-flags", label: "Feature Flags", hint: "Toggles",      layer: "platform", accent: "amber", icon: ToggleRight,   detail: { title: "Feature Flags", bullets: ["Feature toggles", "Gradual rollouts", "A/B testing gates"] }, description: "Feature toggle system for gradual rollouts, A/B testing, and controlled feature releases." },
  { id: "msg-bus",       label: "Message Bus",   hint: "Pub/Sub",      layer: "platform", accent: "amber", icon: Bus,           detail: { title: "Message Bus", bullets: ["Event-driven Pub/Sub", "Inter-service communication", "Async decoupling"] }, description: "Event-driven pub/sub message bus for inter-service communication and async decoupling." },
];
