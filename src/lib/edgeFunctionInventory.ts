...
export const edgeFunctionInventory: EdgeFunctionEntry[] = [
  ...
  { name: "build-learning-pairs", domain: "ai", risk: "low", purpose: "Generate AI training pairs from historical data", usesSharedWrapper: false, hasFeatureFlag: false, hasSmokeCoverage: false, hasAuditLogging: false, migrationPriority: "p0", notes: "Safe candidate for first wrapper migration" },
