          ...
          <div className="px-8 py-8 space-y-6">
            <div className="bg-gray-50 border rounded-xl p-6 space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a
                    href="https://www.crm.rebar.shop/terms"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <div className="flex items-start gap-3">
              ...
              <label htmlFor="accept-terms" className="text-sm text-gray-700 cursor-pointer leading-relaxed">
                ...
                <a href="https://www.crm.rebar.shop/terms" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                  Terms & Conditions
                </a>
