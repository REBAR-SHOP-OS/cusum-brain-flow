...
const menus: Menu[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Recurring Transactions", tab: "recurring" },
      { label: "Recurring Automation", tab: "recurring-auto" },
      { label: "Expenses / Purchases", tab: "expenses" },
      { label: "Auto-Reconciliation", tab: "reconciliation" },
      { label: "Scheduled Reports", tab: "scheduled-reports" },
      { label: "Attachments", tab: "attachments" },
      { label: "Batch Actions", tab: "batch-actions" },
      { label: "AI Audit", tab: "audit" },
      { type: "separator" },
      { type: "label", label: "Tax & Compliance" },
      { label: "Tax Planning (CPA)", tab: "tax-planning" },
      { type: "separator" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Cash Flow (Derived)", tab: "cash-flow" },
      { label: "Cash Flow (QB Native)", tab: "cash-flow-report" },
      { type: "separator" },
      { type: "label", label: "Tax & Compliance" },
      { label: "Tax Filing (HST/GST)", tab: "tax-filing" },
      { type: "separator" },
      { type: "label", label: "Customer Reports" },
      { label: "Customer Statements", tab: "statements" },
      { type: "separator" },
      { type: "label", label: "Aging Reports" },
      { label: "Aged Receivables", tab: "aged-receivables" },
      { label: "Aged Payables", tab: "aged-payables" },
      { type: "separator" },
      { type: "label", label: "Analysis" },
      { label: "Budget vs. Actuals", tab: "budget-vs-actuals" },
      { type: "separator" },
