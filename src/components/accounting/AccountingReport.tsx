    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-3xl font-bold text-emerald-500">{fmt(totalReceivable)}</p>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-3xl font-bold text-blue-500">{fmt(totalPayable)}</p>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className={`text-3xl font-bold ${totalReceivable - totalPayable >= 0 ? "text-emerald-500" : "text-destructive"}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-3xl font-bold text-emerald-500">{fmt(totalInvoiced)}</p>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-3xl font-bold text-blue-500">{fmt(totalBilled)}</p>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className={`text-3xl font-bold ${totalInvoiced - totalBilled >= 0 ? "text-emerald-500" : "text-destructive"}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-3xl font-bold text-emerald-500">{fmt(totalPayments)}</p>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-3xl font-bold text-blue-500">{fmt(totalBilled - totalPayable)}</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6">
      ...
      <Card>
        <CardContent className="p-6 text-center text-muted-foreground">
          <p className="text-sm">Detailed {titles[report].toLowerCase()} report is generated from your synced QuickBooks data.</p>
