              ...
              return (
                ...
                >
                  ...
                  {isEditing ? (
                    ...
                    <span className="text-xs font-bold">{(item as any).source_total_length_text || (unitSystem === "imperial" ? `${item.cut_length_mm || 0}"` : formatLength(item.cut_length_mm, unitSystem))}</span>
                  )}
                  {/* Dim columns */}
                  {dimCols.map(c => {
