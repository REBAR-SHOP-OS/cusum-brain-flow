  ...
  return (
    <div className="border-t border-white/[0.06] bg-zinc-950 select-none">
      ...
      <div ref={scrollContainerRef} className="px-3 py-1.5 space-y-0 relative overflow-x-auto" style={{ scrollbarWidth: "thin" }}>
        ...
        <div className="flex items-center gap-0.5 mt-0.5">
          ...
          <div className="flex-1 h-5 relative rounded bg-zinc-900/50 overflow-hidden" onClick={handleTrackClick}>
            ...
            {textOverlays.map((ov) => {
                ...
                const leftPct = totalDuration > 0 ? ((sceneStart + itemStart) / totalDuration) * 100 : 0;
        ...
        {/* ─── Global Playhead (spans all rows) — offset by label column ─── */}
        <div className="absolute top-0 bottom-0 z-50 pointer-events-none" style={{ left: 'calc(3.5rem + 2px)', right: 0 }}>
          <div
            ref={playheadRef}
            className={`absolute top-0 bottom-0 ${scrubbing ? 'cursor-grabbing' : 'cursor-grab'} pointer-events-auto`}
